...
const Home = ({homes: {homes, home}, loading, getHome, clearHomes, history}) => {
    ...
    return (
        <Fragment>
            {home === null || loading ? <Spinner /> : <Fragment>
            ...
            <SlantedSection className="slantedSection">
                ...
                <FeaturedSection>
                    <div className="featuredProp">
                        <h2 style={{'textAlign': 'center', 'marginBottom': '20px'}}>Featured Property</h2>
                        <div className="featuredPropImgWrap">
                            <Link to={'/home/'+ home.mlsId}><img src={home.photos[0]} alt="Featured Property"/></Link>
                            <div className="img-overlay"></div>
                        </div>
                        <PropertyCard>
                            <div>
                                <p className="propPrice"><Link to={'/home/'+ home.mlsId} className="sale-link">For Sale</Link> <span className="price">{ConvertPrice(home.listPrice)}</span></p>
                                <p className="propLoc">
                                    {home.address.full}
                                    <br />
                                    {home.address.city}, TX {home.address.postalCode}
                                </p>
                                <p className="propDesc">Enchanting three bedroom, three bath home with spacious one bedroom, one bath cabana, in-laws quarters. Charming living area features fireplace…</p>
                            </div>
