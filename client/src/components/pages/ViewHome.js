    ...
    <div>
      {home === null || loading ? (
        ...
        <div className="home-wrapper">
          <div className="flex-container">
            <div className="homeImg-wrapper" onClick={showModal}>
              <div className="action-bar">
                <BackBtn onClick={(e) => goBack(e)}>
                  <FontAwesomeIcon icon="chevron-left" size="lg" />
                </BackBtn>
                {isSaved ? (
                  <SaveBtn onClick={(e) => saveBtnClick(e)}>
            ...
            <PropertyCard>
              <div>
                ...
                <p className="propLoc">
                  {home.address.full}, {home.address.city}, TX{" "}
              ...
              <div className="property-details-container">
                ...
                <div className="card-meta">
                  ...
                  <p>
                    {home.agent.firstName} {home.agent.lastName}
                  </p>
                </div>
                <div className="card-meta">
          ...
          {isLoaded && (
            <GoogleMap
              center={{ lat: home.geo.lat, lng: home.geo.lng }}
              zoom={12}
...
export default connect(mapStateToProps, { getHome, saveHome, deleteSavedHome })(
  ViewHome
);
