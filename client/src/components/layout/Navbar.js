...
const Navbar = ({ isAuthenticated, logout }) => {
  ...
  return (
    <div className="navbar" id="header-nav" style={navbarStyle}>
      <Nav>
        <Logo>
          <Link to="/">Trulocal</Link>
        </Logo>
        <ul>
          <NavbarItem>
      ...
      <MobileNav>
        <Logo>
          <Link to="/" onClick={() => setShowMobileNavMenu(false)}>
            Trulocal
          </Link>
        </Logo>
        {showMobileNavMenu ? (
        ...
        <MobileNavMenu className="mobileNav" show={showMobileNavMenu}>
          <ul>
            <NavbarItem>
              <NavbarLink to="/" className="active" onClick={showMobileNav}>
                Home
              </NavbarLink>
            </NavbarItem>
            <NavbarItem>
              <NavbarLink to="/homes" onClick={showMobileNav}>
                Buy
              </NavbarLink>
            </NavbarItem>
            {isAuthenticated ? (
              ...
              <Fragment>
                <NavbarItem>
                  <NavbarLink to="/register" onClick={showMobileNav}>
                    Sign Up
                  </NavbarLink>
                </NavbarItem>
                <NavbarItem>
                  <NavbarLink to="/login" onClick={showMobileNav}>
                    Login
                  </NavbarLink>
                </NavbarItem>
              </Fragment>
